...
module.exports = {
    ...
    addCommentBySkey: function(req, res, next) {
        Comments.addCommentBySkey(req.body.skey, req.body.content, req.body.topicid).then(function(resData) {
